...
def card_post_delete(sender, **kwargs):
    if kwargs['instance'].move1:
        kwargs['instance'].move1.delete()
    if kwargs['instance'].move2:
        kwargs['instance'].move2.delete()
    if kwargs['instance'].move3:
        kwargs['instance'].move3.delete()
