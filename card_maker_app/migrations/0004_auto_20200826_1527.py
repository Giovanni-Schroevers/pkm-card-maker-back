    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('move', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='card_maker_app.Move')),
        ...
        migrations.AddField(
            model_name='move',
            name='type',
            field=models.ManyToManyField(through='card_maker_app.MoveEnergyCost', to='card_maker_app.Type'),
        ),
        migrations.CreateModel(
            name='Card',
            fields=[
                ...
                ('background_image', models.FileField(blank=True, null=True, upload_to='card/')),
                ('card_image', models.FileField(blank=True, null=True, upload_to='card/')),
                ('top_image', models.FileField(blank=True, null=True, upload_to='card/')),
                ('type_image', models.FileField(blank=True, null=True, upload_to='card/')),
                ('prevolve_image', models.FileField(blank=True, null=True, upload_to='card/')),
                ...
                ('rarity_icon', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='card_maker_app.RarityIcon')),
                ...
                ('rotation', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='card_maker_app.Rotation')),
                ...
                ('super_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='card_maker_app.Supertype')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='card_type', to='card_maker_app.Type')),
                ...
                ('weakness_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='card_weakness', to='card_maker_app.Type')),
            ],
        ),
        migrations.CreateModel(
            name='Ability',
